            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    ...
                    <div class="message">
                        <?php
                        if (!empty($message)) {
                            echo "<p><div class='$messageClass'>$message</div></p>";
                        }
                        ?>
                    </div>
                                ...
                                ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-sm btn-primary" href="manage-admin.php?delid=<?php echo ($row->ID); ?>" onclick="return confirm('Do you really want to Delete?');">Delete</a>
                                                </td>
                                            </tr>
                                <?php
                                            $cnt = $cnt + 1;
