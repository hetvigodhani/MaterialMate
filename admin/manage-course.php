...
{               ?>
                                    ...
                                    <td><a class="btn btn-sm btn-primary" href="manage-course.php?delid=<?php echo ($row->courseid);?>"  onclick="return confirm('Do you really want to Delete ?');">Delete</a></td>
