...
if (strlen($_SESSION['ocasaid']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO tblsubject(ClassID,Subject) VALUES (:cid, :subject)";
...
{               ?>
            <option value="<?php  echo htmlentities($row->ID);?>"><?php  echo htmlentities($row->Class);?></option><?php $cnt=$cnt+1;}} ?>
        </select>
                                </div>
                                <div class="mb-3">
